...
export class DashboardComponent {
  ...
  createInstance(pId) {
    ...
    if (errorM !== "") {
      ...
      this.processStorage.createInstance(
        pId,
        this.caseCreator,
        this.caseCreatorRole
      );
    }
  }
  ...
  nominate() {
    let errorM = "";
    errorM =
      this.checkEmpty(this.nominatorRole, "[Nominator Role] ") +
    ...
    if (errorM !== "") {
      ...
      this.processStorage.nominate(
        this.nominatorRole,
        this.nomineeRole,
        this.nominatorNAddress,
        this.nomineeNAddress,
        this.procesCase
      );
    }
  }
  ...
  release() {
    ...
    if (errorM !== "") {
      ...
      this.processStorage.release(
        this.nominatorRole,
        this.nomineeRole,
        this.nominatorRAddress,
        this.procesCase
      );
    }
  }
  ...
  vote() {
    ...
    if (errorM !== "") {
      ...
      this.processStorage.vote(
        this.nominatorRole,
        this.nomineeRole,
        this.endorserRole,
        this.endorserAddress,
        this.procesCase,
        this.onNomination === "true",
